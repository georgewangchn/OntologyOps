> ⚠️ **未采纳的历史草案 · 非当前定义**
> 本文件把 OntologyOps 重定义为「企业知识运行时**平台/产品**」，与当前采纳的定位（OntologyOps = **方法论**，六支柱；其中 Ontology Repo 支柱带正式协议）**冲突**。
> 当前权威定义见 [`docs/OntologyOps方案.md`](../docs/OntologyOps方案.md) 与 [`protocol/ontology-repo/`](../protocol/ontology-repo/)。
> 此稿仅作归档留存，**不代表当前方向**。
